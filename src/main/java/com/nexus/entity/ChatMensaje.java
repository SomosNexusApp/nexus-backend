...
public class ChatMensaje extends DomainEntity {
    ...
    public void setMediaUrl(String u) {
        this.mediaUrl = u;
    }
    ...
    public void setMediaThumbnail(String t) {
        this.mediaThumbnail = t;
    }

    public Integer getAudioDuracionSegundos() {
        return audioDuracionSegundos;
    }

    public void setAudioDuracionSegundos(Integer d) {
        this.audioDuracionSegundos = d;
    }
    ...
    public void setTipo(TipoMensaje t) {
        this.tipo = t;
    }
    ...
    public void setPrecioPropuesto(Double p) {
        this.precioPropuesto = p;
    }
    ...
    public void setEstadoPropuesta(String e) {
        this.estadoPropuesta = e;
    }
